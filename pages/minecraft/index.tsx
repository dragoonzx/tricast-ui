...
import TricastComponent from "../../components/TricastComponent";
    ...
    <main className="relative container mx-auto bg-white px-4">
      ...
      <article className="max-w-prose mx-auto py-8">
        <h1 className="text-2xl font-bold">
          Music Event Party, Awards 2021. Exclusive after party only for special
          guests.
        </h1>
      ...
      <div className="mx-auto w-72 mb-12">
        <TricastComponent title="Will Drake be on party?" market="music" />
      </div>
    </main>
  );
};
